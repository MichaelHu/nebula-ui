...
function InnerApp() {
  ...
  const renderContent = () => {
        ...
        return (
             <DocViewer
                doc={{
                    ...
                    usage: `import { Space } from '@/components/ui/Space';\n\n<Space size="lg"><Button>1</Button><Button>2</Button></Space>`,
    ...
    case 'input':
         return (
          <DocViewer
            doc={{ id: 'input', title: 'Input 输入框', description: '基础输入。', usage: '', api: [] }}
    ...
    case 'select':
        return (
            <DocViewer
                doc={{ id: 'select', title: 'Select 选择器', description: '下拉选择器。', usage: '', api: [] }}
    ...
    case 'checkbox':
        return (
            <DocViewer
                doc={{ id: 'checkbox', title: 'Checkbox 多选框', description: '多选。', usage: '', api: [] }}
    ...
    case 'radio':
        return (
            <DocViewer
                doc={{ id: 'radio', title: 'Radio 单选框', description: '单选。', usage: '', api: [] }}
    ...
    case 'switch':
        return (
            <DocViewer
                doc={{ id: 'switch', title: 'Switch 开关', description: '开关。', usage: '', api: [] }}
    ...
    case 'avatar':
         return (
            <DocViewer
                doc={{ id: 'avatar', title: 'Avatar 头像', description: '头像。', usage: '', api: [] }}
    ...
    case 'badge':
         return (
            <DocViewer
                doc={{ id: 'badge', title: 'Badge 徽标', description: '徽标。', usage: '', api: [] }}
    ...
    case 'tag':
         return (
            <DocViewer
                doc={{ id: 'tag', title: 'Tag 标签', description: '标签。', usage: '', api: [] }}
    ...
    case 'card':
         return (
            <DocViewer
                doc={{ id: 'card', title: 'Card 卡片', description: '通用容器。', usage: '', api: [] }}
    ...
    case 'alert':
         return (
            <DocViewer
                doc={{ id: 'alert', title: 'Alert 警告提示', description: '警告提示。', usage: '', api: [] }}
    ...
    case 'modal':
         return (
            <DocViewer
                doc={{ id: 'modal', title: 'Modal 对话框', description: '模态对话框。', usage: '', api: [] }}
                preview={
                    <>
